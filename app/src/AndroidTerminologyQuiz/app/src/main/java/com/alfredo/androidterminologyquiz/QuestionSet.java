...
public class QuestionSet
{
    ...
    public void setShortAnswerQuestions(){
        ...
        questionsArray[0].questionHeader = "Short answer question 0";
        questionsArray[1].questionHeader = "Short answer question 1";
        questionsArray[2].questionHeader = "2";
        questionsArray[3].questionHeader = "3";
